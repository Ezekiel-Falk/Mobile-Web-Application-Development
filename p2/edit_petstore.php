	...
	<div class="container">
		<div class="starter-template">
					...
					<h2>Pet Stores</h2>
						...
						<form id="edit_petStore_form" method="post" class="form-horizontal" action="edit_petstore_process.php">

								<?php
								/*
									Use hidden form field to pass back petstore ID with other displayed attribute values, to database.
									Also, don't put these types of comments in HTML comments, can be 
									viewed when looking through HTML source code

									Lastly, don't permit user to modify pk (pst_id), only allow modifications to the associated data.
								*/
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="url" placeholder="Example: www.jdow.com" value="<?php echo $result['pst_url']; ?>"/>
										</div>
								</div>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
	...
	$('#edit_petStore_form').formValidation({
