	...
	<div class="container">
		<div class="starter-template">
					...
					<h2>Pet Stores</h2>
						...
						<form id="add_petStore_form" method="post" class="form-horizontal" action="add_petstore_process.php">
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="url" placeholder="Example: www.jdow.com"/>
										</div>
								</div>
