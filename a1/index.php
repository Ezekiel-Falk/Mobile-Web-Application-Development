		...
		<div class="container">
			<div class="starter-template">
				...
				<p class="text-justify">
					<strong>Description:</strong> In this assignment I learned how to use bitbucket service for managing Git repositories as well as the git command line tool.
				</p>
				...
				<img src="img/andriodscreenShot.png" class="img-responsive center-block" alt="Android Studio Installation">
